            ...
            <Form class="col-12" :initial-values="product_subcategory" :validation-schema="validationSchema_product_subcategory" @submit.capture="onSubmit">
                <div class="field">
                    <Field id="name" name="name" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product_subcategory.name" class="input" />
                ...
                <div class="field">
                    <Field id="id_product_category" name="id_product_category" v-slot="{ handleChange, handleBlur }">
                        ...
                        <Dropdown v-model="product_subcategory.id_product_category" :options="product_category_data" optionLabel="name" optionValue="id" placeholder="Selecione Categoria" class="w-full" />
                ...
                <div class="field">
                    <Field id="description" name="description" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product_subcategory.description" class="input" />
                ...
                <div class="field">
                    <Field id="url_image" name="url_image" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product_subcategory.url_image" class="input" />
