            ...
            <Form class="col-12" :initial-values="product" :validation-schema="validationSchema_product" @submit.capture="onSubmit">
                <div class="field">
                    <Field id="name" name="name" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product.name" class="input" />
                ...
                <div class="field">
                    <Field id="description" name="description" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product.description" class="input" />
                ...
                <div class="field">
                    <Field id="price" name="price" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model.lazy="product.price" v-money3="moneyConfig" class="input" />
                ...
                <div class="field">
                    <Field id="image" name="image" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="product.image" class="input" />
                ...
                <div class="field">
                    <Field id="id_product_category" name="id_product_category" v-slot="{ handleChange, handleBlur }">
                        ...
                        <Dropdown v-model="product.id_product_category" :options="product_category_data" optionLabel="name" optionValue="id" placeholder="Selecione Categoria" class="w-full" />
                ...
                <div class="field">
                    <Field id="id_product_subcategory" name="id_product_subcategory" v-slot="{ handleChange, handleBlur }">
                        ...
                        <Dropdown v-model="product.id_product_subcategory" :options="product_subcategory_data" optionLabel="name" optionValue="id" placeholder="Selecione Subcategoria" class="w-full" />
