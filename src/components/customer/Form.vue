            ...
            <Form class="col-12" :initial-values="customer" :validation-schema="validationSchema_customer" @submit.capture="onSubmit">
                <div class="field">
                    <Field id="name" name="name" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.name" class="input" />
                ...
                <div class="field">
                    <Field id="email" name="email" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.email" class="input" />
                ...
                <div class="field">
                    <Field id="phone_number" name="phone_number" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.phone_number" class="input" />
                ...
                <div class="field">
                    <Field id="doc_cpf" name="doc_cpf" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.doc_cpf" class="input" />
                ...
                <div class="field">
                    <Field id="date_of_birth" name="date_of_birth" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="date" @change="handleChange" @blur="handleBlur" v-model="customer.date_of_birth" class="input" />
                ...
                <div class="field">
                    <Field id="address_line_1" name="address_line_1" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.address_line_1" class="input" />
                ...
                <div class="field">
                    <Field id="address_line_2" name="address_line_2" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.address_line_2" class="input" />
                ...
                <div class="field">
                    <Field id="city" name="city" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.city" class="input" />
                ...
                <div class="field">
                    <Field id="country" name="country" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.country" class="input" />
                ...
                <div class="field">
                    <Field id="state" name="state" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.state" class="input" />
                ...
                <div class="field">
                    <Field id="zip_code" name="zip_code" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="customer.zip_code" class="input" />
