            ...
            <Form class="col-12" :initial-values="offer" :validation-schema="validationSchema_offer" @submit.capture="onSubmit">
                <div class="field">
                    <Field id="id_product" name="id_product" v-slot="{ handleChange, handleBlur }">
                        ...
                        <Dropdown v-model="offer.id_product" :options="product_data" optionLabel="name" optionValue="id" placeholder="Selecione Produto" class="w-full" />
                ...
                <div class="field">
                    <Field id="price" name="price" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model.lazy="offer.price" v-money3="moneyConfig" class="input" />
                ...
                <div class="field">
                    <Field id="quantity" name="quantity" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="text" @change="handleChange" @blur="handleBlur" v-model="offer.quantity" class="input" />
                ...
                <div class="field">
                    <Field id="initial_date" name="initial_date" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="date" @change="handleChange" @blur="handleBlur" v-model="offer.initial_date" class="input" />
                ...
                <div class="field">
                    <Field id="final_date" name="final_date" v-slot="{ handleChange, handleBlur }">
                        ...
                        <InputText type="date" @change="handleChange" @blur="handleBlur" v-model="offer.final_date" class="input" />
