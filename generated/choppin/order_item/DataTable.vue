<template>
        ...
        >
            ...
            <Column sortable field="id_order" header="Pedido">
                <template #body="slotProps">
                    <span class="p-column-title">Pedido</span>
                    {{ slotProps.data.id_order_data ? slotProps.data.id_order_data.id : '-' }}
                </template>
            </Column>
            ...
            <Column sortable field="product_price" header="Preço">
                <template #body="slotProps">
